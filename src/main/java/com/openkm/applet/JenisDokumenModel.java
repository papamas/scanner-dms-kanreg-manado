...
public class JenisDokumenModel {
    ...
    public static DefaultComboBoxModel getDefaultModel(){
        ...
        model.addElement(new Item(36,"Surat Keputusan Pemberhentian Sementara","PEMBERHENTIAN","SK_PEMBERHENTIAN_SEMENTARA"));
        ...
        model.addElement(new Item(69,"Surat Keputusan Pemberhentian","PEMBERHENTIAN","SK_PEMBERHENTIAN"));
        model.addElement(new Item(70,"Surat Keputusan Kenaikan Pangkat Pengabdian","PENSIUN","SKKP_PENGABDIAN"));
        ...
        model.addElement(new Item(74,"Nota Pertimbangan Teknis Pemberian Pensiun","PENSIUN","PERTEK_PENSIUN"));
        ...
        model.addElement(new Item(80,"Surat Pemberhentian Gaji atau Surat Keterangan Pemberhentian Pembayaran ","GAJI","SKPP"));
        model.addElement(new Item(81,"Surat Pernyataan CPNS","SURAT PERNYATAAN","SUPER_CPNS"));
        model.addElement(new Item(82,"Surat Pernyataan Rencana Penempatan","SURAT PERNYATAAN","SUPER_RENCANA_PENEMPATAN"));
        ...
        model.addElement(new Item(86,"Surat Pernyataan Tidak Pernah Dijatuhi Hukuman Disiplin (HD)","HUKUMAN DISIPLIN","SUPER_TDK_PERNAH_HD"));
        model.addElement(new Item(87,"Surat Pernyataan Tidak Sedang menjalani Proses Pidana","PIDANA","SUPER_TDK_SEDANG_PIDANA"));
