...
public class JenisDokumenModel {
    ...
    static {
        ...
        model.addElement(new Item(74,"Nota Pertimbangan Pemberian Pensiun","PENSIUN","NOTA_PERTIMBANGAN_PEMBERIAN_PENSIUN"));
        model.addElement(new Item(75,"Pangkalan Data Direktorat Perguruan Tinggi","DIKTI","PANGKALAN_DATA_DIKTI"));
        model.addElement(new Item(76,"Data Perorangan Penerima Calon Pensiun","PENSIUN","DPCP"));
        ...
        model.addElement(new Item(86,"Surat Pernyataan Tidak Dijatuhi Hukuman Disiplin","HUKUMAN DISIPLIN","SURAT_PERNYATAAN_TDK_PERNAH_HD"));
        model.addElement(new Item(87,"Surat Pernyataan Tidak Dijatuhi Hukuman Pidana","PIDANA","SURAT_PERNYATAAN_TDK_SEDANG_PIDANA")); 
        ...
        model.addElement(new Item(90,"Surat Permohonan berhenti atas permintaan sendiri sebagai PNS","PENSIUN","SURAT_PERMOHONAN_APS"));
    }
